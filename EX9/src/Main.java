...
public class Main {
    public static void main(String[] args) {
        ...
        empleados.stream()
                .sorted(Comparator.comparing(Employee::getSueldo).reversed())
                .forEach(System.out::println);

        System.out.println("\nEmpleados ordenados por departamento y sueldo (ascendente):");
        empleados.stream()
                .sorted(Comparator.comparing(Employee::getDepartamento)
                        .thenComparing(Employee::getSueldo))
                .forEach(System.out::println);
    }
}
